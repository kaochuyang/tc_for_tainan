...
//OT20140211
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan00", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(0, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan01", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(1, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan02", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(2, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan03", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(3, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan04", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(4, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan05", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(5, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan06", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(6, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan07", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(7, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan08", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(8, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan09", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(9, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan10", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(10, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan11", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(11, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan12", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(12, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan13", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(13, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan14", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(14, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan15", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(15, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan16", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(16, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan17", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(17, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan18", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(18, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan19", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(19, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan20", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(20, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan21", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(21, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan22", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(22, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan23", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(23, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan24", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(24, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan25", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(25, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan26", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(26, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan27", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(27, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan28", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(28, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan29", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(29, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan30", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(30, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan31", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(31, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan32", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(32, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan33", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(33, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan34", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(34, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan35", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(35, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan36", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(36, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan37", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(37, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan38", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(38, true); }
    iTmp = oStorINI.vLoadIntFromINI("TODPed", "plan39", 0); if(iTmp > 0) { smem.vSetPlanForceTOD(39, true); }
...
//OT Debug 0523
    ...
    } else if (iCom2Type == Com2IsGPSPort || iCom2Type == Com2IsHOLUXGPSPort) {       //¶}±ÒGPS Port
...
//    if (lcd240x128.GetAuthority(0x278)) {                                       //±o¨ìkernalÅv­­,¥i¥H±±¨îLPT1
    ...
    //pthread_t tidTimerHandle;                                                   //¶}¥t¤@­Óthread,±±¨îtimer
...
//    if (smem.ssPort.CloseRs232Port()) printf("Close SSPort Successful!!\n");
    ...
    if(iCom2Type == Com2IsTesterPort) {      //¶}±Òtest°ð
    } else if (iCom2Type == Com2IsGPSPort || iCom2Type == Com2IsHOLUXGPSPort) {       //¶}±ÒGPS Port
