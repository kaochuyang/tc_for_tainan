                ...
                case( RTSIGNAL_Timer ):
                      ...
                      switch (VDrid) {
                              ...
                              //WatchDog
                                  ...
                                  else if (tempFace==cCURRENTLIGHTSTATUS) { screenCurrentLightStatus.vRefreshStepSec(); screenCurrentLightStatus.DisplayDynSegStatus(); }
...
/*
                                  ...
                                  if(ucCounterWDTForLightboardRedcount > 1) {
                                    ...
                                    _itTrafficeLight.it_value.tv_sec = 0;
                                    _itTrafficeLight.it_value.tv_nsec = 500000000;  // 0.5 sec.
